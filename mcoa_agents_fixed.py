"""
Marine Corps Operations Assistant (MCOA) - Fixed Agent Definitions
This version simulates multi-agent behavior without actual handoffs
"""
...
# This agent has all tools but uses role-based instructions to simulate multiple agents
